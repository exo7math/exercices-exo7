...
\psplot[linecolor=blue,plotpoints=100]{0.758}{5.5}{x dup mul 2 mul 3 x mul sub 1 add 4 x mul 3 sub div}
\psplot[linecolor=blue,plotpoints=1000]{-5.5}{0.744}{x dup mul 2 mul 3 x mul sub 1 add 4 x mul 3 sub div}
\end{pspicture}
\end{center}
