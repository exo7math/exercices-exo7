...
\psaxes{->}(0,0)(-5.3,-5.3)(5.3,5.3)
\parametricplot[linecolor=blue,plotpoints=10000]{-10000}{5000}{2 2.718 0.01 t mul 180 div 3.1415 mul exp mul t cos mul 2 2.718 0.01 t mul 180 div 3.1415 mul exp mul t sin mul}
\put(4,4.5){tracé quand}
\put(4,4){$a=2$, $b=0,01$}
\end{pspicture}
\end{center}
