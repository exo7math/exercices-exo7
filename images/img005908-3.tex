...
\begin{center}
\begin{pspicture}(-4,-2.44)(4,2.4)
\psset{xunit=2cm,yunit=2cm}

\pscircle[fillstyle=solid,fillcolor=Goldenrod,linecolor=blue](0,0){2}
\pscircle[fillstyle=solid,fillcolor=white,linecolor=blue](0.5,0){1}
