...
\psline{->}(-0.5,0)(2.5,0)
\psline{->}(0,-1.5)(0,1.5)
\parametricplot[linecolor=blue,plotpoints=1000]{-180}{180}{
t cos 1 add t cos mul 
t cos 1 add t sin mul}
\parametricplot[linecolor=red,plotpoints=1000]{-180}{180}{
1 t cos sub 3 div t cos mul 0.666 add
1 t cos sub 3 div t sin mul}
\uput[d](1,0){$a$}
\uput[dr](2,0){$2a$}
\uput[ul](0,1){$a$}
\uput[dl](0,-1){$-a$}
