...
\psplot[linecolor=blue,plotpoints=100]{-0.4}{5.5}{x dup mul 32 mul 4 add sqrt 27 sqrt x mul sub}
\psplot[linecolor=blue,plotpoints=100]{-5.5}{0.4}{x dup mul 32 mul 4 add sqrt neg 27 sqrt x mul sub}
\end{pspicture}
\end{center}
