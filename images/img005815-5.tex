...
\begin{center}
\begin{pspicture}(-5.5,-5.5)(5.5,1.5)
\psaxes{->}(0,0)(-5.5,-5.5)(5.5,1.5)
\psplot[linecolor=blue,plotpoints=100]{0.5}{5.5}{x 6 mul neg 18 x mul 9 sub sqrt add 9 div}
\psplot[linecolor=blue,plotpoints=100]{0.5}{5.5}{x 6 mul neg 18 x mul 9 sub sqrt sub 9 div}
\end{pspicture}
\end{center}
