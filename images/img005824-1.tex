...
\begin{center}
\begin{pspicture}(-0.5,-0.5)(8,8)
\psaxes{->}(0,0)(-0.5,-0.5)(7.5,7.5)
\psdots[linecolor=blue](1,0)(0,2)
\psplot[linecolor=blue,plotpoints=1000]{0}{0.9}{2 x mul 2 add 16 x mul sqrt add}
\psplot[linecolor=blue,plotpoints=1000]{0}{7}{2 x mul 2 add 16 x mul sqrt sub}
\end{pspicture}
\end{center}
